        ...
        <div className="flex items-center gap-4 md:gap-8">
          <Link href="/" onClick={() => setIsMenuOpen(false)}>
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="text-xl font-semibold cursor-pointer transition-transform duration-300 hover:text-yellow-300 relative inline-block group"
            >
              Inicio
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-yellow-300 group-hover:w-full transition-all duration-700 ease-in-out inline-block" />
            </motion.div>
          </Link>
        ...
        >
          <Link href="/buscador" onClick={() => setIsMenuOpen(false)}>
            <motion.div
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.95 }}
              className="text-xl font-semibold cursor-pointer transition-transform duration-300 hover:text-yellow-300 relative inline-block group md:mb-0 mb-4"
            >
              Buscador
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-yellow-300 group-hover:w-full transition-all duration-700 ease-in-out inline-block" />
            </motion.div>
